...
public class AppInitServiceImpl implements IAppInitService
{
    ...
    public void initUsers()
    {
        ...
        users.add(new Client(null, "username1", "email1@email.com", "123", null, new Date()));
        users.add(new Manager(null, "username2", "email2@email.com", "123", null, new Date()));
        users.add(new Client(null, "username3", "email3@email.com", "123", null, new Date()));
        users.add(new Manager(null, "username4", "email4@email.com", "123", null, new Date()));
        for (User user : users)
        {
